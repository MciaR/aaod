...
if __name__ == '__main__':
    ...
    config_file = 'configs/faster_rcnn_r101_fpn_voc.py'
    checkpoint_file = '.work_dir/fr_r101_voc/epoch_9_map07699.pth'
    ...
    dataset = vis.dataset
    vis.show_cmp_results(data_samples=dataset[0]['data_samples'], stage='backbone', save=False, grey=False)
