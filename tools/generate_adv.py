...
if __name__ == "__main__":
    ...
    # TODO: FRMR, CenterNet, COCO breakpoint on cuda:0- 1890, cuda:1-4421
    # Time consume: cuda0: 24:50:33 24:50:42. ETA  ~8h
    
    # p1 = Process(target=generate_and_save, args=(1889 / 5000, 2500 / 5000, model, dataset_name, attacker_name, 'cuda:0'))
    # p2 = Process(target=generate_and_save, args=(4420 / 5000, 5000 / 5000, model, dataset_name, attacker_name, 'cuda:1'))
    # p1.start()
    # p2.start()
    # processes = [p1, p2]
